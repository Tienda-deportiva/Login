<?php 
    ...
    class UsuariosController{
        ...
        public function consult(){
            $obj=new UsuariosModel();
            $sql="SELECT usuarios.cod_user,usuarios.nom_user, usuarios.ape_user, usuarios.corr_user, usuarios.login_user, usuarios.pass_user, usuarios.cod_rol, roles.nom_rol FROM usuarios,roles WHERE usuarios.cod_rol=roles.cod_rol";
