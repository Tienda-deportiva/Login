    ...
    <div id="responsive-nav">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Productos<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="<?php echo getUrl("Producto","Producto","getInsert"); ?>">Registrar Producto</a></li>
            <li><a class="dropdown-item" href="<?php echo getUrl("Producto","Producto","consult"); ?>">Consultar Producto</a></li>
          </ul>
        </li>
        <!--Maria-->
